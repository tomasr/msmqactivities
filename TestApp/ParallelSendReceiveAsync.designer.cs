...
namespace TestApp
{
	public sealed partial class ParallelSendReceiveAsync
	{
		...
		private void InitializeComponent()
		{
         ...
         activitybind2.Name = "ParallelSendReceiveAsync";
         activitybind2.Path = "QUEUE";
         activitybind3.Name = "ParallelSendReceiveAsync";
         activitybind3.Path = "CustomerReceived";
         // 
         // ReceiveMessage
         // 
         activitybind1.Name = "ParallelSendReceiveAsync";
         ...
         activitybind6.Name = "ParallelSendReceiveAsync";
         activitybind6.Path = "QUEUE";
         // 
         // SendMessage
         // 
         this.SendMessage.IsTransactionalQueue = true;
         activitybind4.Name = "ParallelSendReceiveAsync";
         activitybind4.Path = "LabelToSend";
         activitybind5.Name = "ParallelSendReceiveAsync";
         ...
         // 
         // ParallelSendReceiveAsync
         // 
         this.Activities.Add(this.parallelActivity1);
         this.Name = "ParallelSendReceiveAsync";
